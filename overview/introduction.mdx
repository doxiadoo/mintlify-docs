---
title: "Introduction"
description: "Learn how to set up lowest in your server or enhance your everyday use with commands & more."
...
<CardGroup cols={2}>
  <Card title="Security Setup" icon="hammer" href="/security">
    Quickly configure your server to use lowest's advanced moderation system.
  </Card>
