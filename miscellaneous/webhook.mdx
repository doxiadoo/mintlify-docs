...
<CodeGroup>
  ...
  ```javascript Example
  ,webhook send bf48da54 hello
  ,webhook send bf48da54 {embed}$v{title: hello} --add {embed}$v{title: hi}
  ```
</CodeGroup>
...
<CodeGroup>
  ```javascript Syntax
  ,webhook edit (identifier) (message id) (new message)
  ```

  ```javascript Example
  ,webhook edit 95a057cd 1343257895323832321 hello world
  ```
</CodeGroup>
...
<Frame>
  <img src="/images/miscellaneous/webhook/edit.pn" />
</Frame>
