...
We welcome new contributions. Please create a [Pull Request](https://github.com/doxiadoo/mintlify-docs/pulls) if you would like to contribute to our documentation. For new contributors, we advise you to familiarize yourself with [MDX](https://mintlify.com/docs/page) and see [Contributing.md](https://github.com/ju/docs/blob/main/CONTRIBUTING.md) before requesting any changes.
